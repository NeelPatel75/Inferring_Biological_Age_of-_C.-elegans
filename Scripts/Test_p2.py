...
INPUT_DIR = os.path.join(BASE_DIR, "/home/npatel79/Inferring_Biological_Age_of-_C.-elegans/test_results/Kallisto_samples")
...
samples = [f"SRR284795{i}" for i in range(25, 27)]
all_data = []
